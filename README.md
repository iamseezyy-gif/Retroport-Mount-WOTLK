...
🛠️ Template M2.bt → Va dans nViews → Change par le nombre de skins que tu vois dans le dossier "Creature" → Save
...
🔹 Duplique une ligne → Change ID (ex: 76000) + ModelPath vers ton modèle et ajouter les textures dans "TextureVariation"
...
🔮 Change : ID (ex:500001) + EffectMiscValue_1 (c'est ton display ID) (76000)
1️⃣3️⃣ Item.dbc
